...
if (isset($_POST['ubah'])) {
    ...
    $update = mysqli_query($con, "UPDATE prodev SET merek_id='$merek_id', kategori_id='$kategori_id', deskripsi='$deskripsi', price='$price', stok='$stok', price_perUnit='$price_perUnit' WHERE idbarang='$id'") or die("Error: " . mysqli_error($con));

    $kode_budget = $_POST['kode_budget'];
    $ket = $_POST['ket'];
    //untuk insert di table log departemen terkait
    $log_update = mysqli_query($con, "INSERT INTO trnsk_prodev (kode_budget, merek_id, kategori_id, deskripsi, price, stok, ket) VALUES ('$kode_budget', '$merek_id', '$kategori_id', '$deskripsi', '$price', '$stok', '$ket')") or die("Error: " . mysqli_error($con));
