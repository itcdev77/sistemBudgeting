                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="price" id="price_budget" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3" style="margin-left: 8.5%;">
                                <label for="deskripsi">BGT 2:</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">Rp.</span>
                                    </div>
                                    <input type="text" class="form-control" name="price" id="split2" readonly>
                                </div>
                            </div>
